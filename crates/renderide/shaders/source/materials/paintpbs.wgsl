...
fn fs_forward_base(
    ...
    return shade(frag_pos.xy, world_pos, world_n, uv_main, uv_paint, view_layer, true, false);
}
...
fn fs_forward_delta(
    ...
    return shade(frag_pos.xy, world_pos, world_n, uv_main, uv_paint, view_layer, false, true);
}
