//! Per-object grab-pass threshold filter (`Shader "Filters/Threshold_PerObject"`).
...
struct FiltersThresholdPerObjectMaterial {
    _Threshold: f32,
    _Transition: f32,
    _GrabPass: f32,
    _pad0: f32,
...
@group(1) @binding(0) var<uniform> mat: FiltersThresholdPerObjectMaterial;
