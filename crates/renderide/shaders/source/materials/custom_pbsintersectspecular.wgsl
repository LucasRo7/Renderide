//! Alias for `Shader "Custom/PBSIntersectSpecular"` path-based routing.
//!
...
@group(1) @binding(0)  var<uniform> mat: CustomPbsIntersectSpecularMaterial;
...
fn fs_main(
    ...
    let color = (amb * base_color * occlusion + lo) + emission;
