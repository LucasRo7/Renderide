...
//#pass forward: fs=fs_forward_base, depth=greater_equal, zwrite=off, cull=none, blend=one,one_minus_src_alpha,add, alpha=one,one_minus_src_alpha,add
