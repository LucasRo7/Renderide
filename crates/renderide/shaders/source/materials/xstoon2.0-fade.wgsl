//! Xiexe Toon 2.0 fade transparency (`Shader "Xiexe/Toon2.0/XSToon2.0_Fade"`).

// unity-shader-name: Xiexe/Toon2.0/XSToon2.0_Fade
//#pass forward: fs=fs_forward_base, depth=greater_equal, zwrite=off, cull=none, blend=src_alpha,one_minus_src_alpha,add, alpha=src_alpha,one_minus_src_alpha,add
//#pass forward_delta: fs=fs_forward_delta, depth=greater_equal, zwrite=off, cull=none, blend=src_alpha,one,add, alpha=src_alpha,one,add

#import renderide::xiexe::toon2 as xs

const XIEE_ALPHA_MODE: u32 = 5u;
