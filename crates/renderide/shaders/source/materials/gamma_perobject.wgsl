//! Per-object grab-pass gamma filter (`Shader "Filters/Gamma_PerObject"`).
...
struct FiltersGammaPerObjectMaterial {
    _Gamma: f32,
    _GrabPass: f32,
    _pad0: vec2<f32>,
}

@group(1) @binding(0) var<uniform> mat: FiltersGammaPerObjectMaterial;
