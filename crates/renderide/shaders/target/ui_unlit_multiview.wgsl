...
@vertex 
fn vs_main(@builtin(view_index) view_idx: u32, @location(0) pos: vec4<f32>, @location(1) _n: vec4<f32>, @location(2) uv: vec2<f32>, @location(3) color: vec4<f32>) -> VertexOutput {
    var vp: mat4x4<f32>;
    ...
    out.uv = uv;
    let _e28: vec4<f32> = mat._Tint;
    out.color = (color * _e28);
    out.obj_xy = pos.xy;
