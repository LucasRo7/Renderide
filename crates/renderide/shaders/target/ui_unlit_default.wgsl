...
@vertex 
fn vs_main(@builtin(instance_index) instance_index: u32, @location(0) pos: vec4<f32>, @location(1) _n: vec4<f32>, @location(2) uv: vec2<f32>, @location(3) color: vec4<f32>) -> VertexOutput {
    ...
    out.uv = uv;
    let _e18: vec4<f32> = mat._Tint;
    out.color = (color * _e18);
    out.obj_xy = pos.xy;
